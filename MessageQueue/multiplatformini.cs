...
using System.Threading;
	...
	public class MultiplatformIni
    {
        ...
        public String ReadString(String section, String key, String defaultValue)
        {
           ...
           lock (objLock)
           {
               FileStream fileStream = new FileStream(iniFilePath, FileMode.OpenOrCreate, FileAccess.Read, FileShare.ReadWrite);
        ...
        public void Flush()
        {
            ...
            FileStream fileStream = new FileStream(iniFilePath, FileMode.OpenOrCreate, FileAccess.Read, FileShare.ReadWrite);
                ...
                // Finally write our file
                    fileStream = new FileStream(iniFilePath, FileMode.Create, FileAccess.Write, FileShare.ReadWrite);
